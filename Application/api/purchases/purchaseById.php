...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['customerId']) && !empty($_POST['customerId'])) {
        ...
        $customer = isset($_POST['customerId']) ? trim($_POST['customerId']) : '';
        ...
        try {
            ...
            $response = $client->request('GET', 'purchase/by/customer', [
                'query' => [
                    'customerId' => $customer, // Aquí va el parámetro de búsqueda
                ],
            ]);
