...
<footer class="page-footer" role="contentinfo">
    <div class="d-flex align-items-center flex-1 text-muted">
        <span class="hidden-md-down fw-700"><?php echo date('Y'); ?>© Promos by&nbsp;<a href='https://enrsr.mx' class='text-primary fw-500' title='Enerser MKT' target='_blank'>@Enerser MKT</a></span>
    </div>
    <div>
