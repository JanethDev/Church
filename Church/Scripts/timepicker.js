...
(function($){
  ...
  function _bindTimepicker($picker, $input){
    ...
    $picker.find(".ok-button").css("background-color", "white");
    ...
    // When the cancel button was pushed, just remove the timepicker.
      ...
      $picker.find(".cancel-button").css("background-color", "white");
